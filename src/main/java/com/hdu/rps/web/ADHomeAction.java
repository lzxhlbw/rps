...
public class ADHomeAction {
    ...
    @RequestMapping("/userManage/add")
    public String userManageAdd() {
        logger.info("-----/ad/userManage/add-----");
        return "userManageAdd";
    }
    
    @RequestMapping("/userManage/add/submit")
    public String userManageAddSubmit(@RequestParam String name,@RequestParam String phone,
                                    @RequestParam String email,@RequestParam String password,
                                    @RequestParam String sex) {
        adServiceImpl.userManageAddSubmit(name,phone,email,password,sex);
        return "redirect:/ad/userManage";
    }
